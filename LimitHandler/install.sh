...
wget -q -O /usr/bin/monitor.py https://raw.githubusercontent.com/vpncirebon/vpnscripts/main/LimitHandler/monitor.py
wget -q -O /usr/bin/triall_clean.py https://raw.githubusercontent.com/vpncirebon/vpnscripts/main/LimitHandler/triall_clean.py
